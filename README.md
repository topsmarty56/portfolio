# MyMind - Nakamura Kenta Portfolio

Welcome to **MyMind**, the dynamic portfolio website of **Nakamura Kenta**. This portfolio showcases my work and achievements, built with **ReactJS**, **Tailwind CSS**, and **Firebase** for backend integration. It is optimized for a seamless experience across both desktop and mobile devices.
